...
If callback was requested on transaction submit, merchant should receive a notification of doublespend and/or merkle proof via callback URL. mAPI will process all requested notifications and will send them out in batches.
Callbacks have three possible callBackReasons: "doubleSpend", "doubleSpendAttempt" and "merkleProof". DoubleSpendAttempt implies that a doublespend was detected in mempool.
